...
AUDIO_MEN_VACANT = os.getenv("AUDIO_MEN_VACANT", "")
AUDIO_MEN_OCCUPIED = os.getenv("AUDIO_MEN_OCCUPIED", "")
AUDIO_WOMEN_VACANT = os.getenv("AUDIO_WOMEN_VACANT", "")
AUDIO_WOMEN_OCCUPIED = os.getenv("AUDIO_WOMEN_OCCUPIED", "")